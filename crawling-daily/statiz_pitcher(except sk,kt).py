...
#파일 생성
f=open(r'C:\Users\s137\OneDrive\바탕 화면\statiz_crawling\투수(kt,sk제외).csv','w',encoding='cp949',newline='')
...
#팀별 크롤링
for k in range(2,11):
    team_move = driver.find_element(By.XPATH,"/html/body/div[1]/div[1]/div/section[2]/div/div[2]/div[1]/div/div[3]/ul/div[1]/button["+str(k)+"]")
