...
#파일 생성
f=open(r'C:\Users\s137\OneDrive\바탕 화면\statiz_crawling\투수sk.csv','w',encoding='cp949',newline='')
csvWriter = csv.writer(f)

# 웹페이지 주소로 이동(한번에 투구 탭으로 이동)
...
#규정이닝 선택
reg = driver.find_element(By.XPATH,"/html/body/div/div[1]/div/section[2]/div/div[2]/div[1]/div/div[6]/button")
reg.send_keys(Keys.ENTER)
time.sleep(3)

#규정이닝 25이닝 이상으로 필터링
reg_50 = driver.find_element(By.XPATH,"/html/body/div/div[1]/div/section[2]/div/div[2]/div[1]/div/div[6]/ul/div/button[10]")
reg_50.send_keys(Keys.ENTER)
time.sleep(3)

# #옵션 클릭
option = driver.find_element(By.XPATH,"/html/body/div/div[1]/div/section[2]/div/div[2]/div[1]/div/div[8]/button")
...
# #50개로 확장
expand_100 = driver.find_element(By.XPATH,"/html/body/div/div[1]/div/section[2]/div/div[2]/div[2]/div[2]/div[5]/form/select/option[4]")
expand_100.click()
time.sleep(3)

#올드팀(SK) 크롤링
team_move = driver.find_element(By.XPATH,"/html/body/div/div[1]/div/section[2]/div/div[2]/div[1]/div/div[3]/ul/div[2]/button[11]")
