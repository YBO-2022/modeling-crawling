...
temp = pd.read_csv('/content/drive/Shareddrives/[2022-1 Ybigta] 타율 어쩌구 구단이 울랄라/모델링팀/최종/hitter.csv', encoding="UTF-8")
...
data.to_csv('test_ops.csv', encoding="UTF-8")
